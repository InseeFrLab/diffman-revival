...
area_z1_at_risk <- l_area_z1_at_risk[[115]]
area_z1_at_risk
...
```
## TO DO :
- faire des statistiques de carreaux blanchis vs carreaux sous le seuil avec le scénario où on blanchit tious les carreaux au frontière (ou un seul ?) on casse le lien en faisant ça d'ailleurs réfléchir à ce que ça veut dire ?
