...
paquets <- c("data.table","btb","remotes","sf","igraph","Matrix","leaflet","dplyr","prettydoc","devtools","testthat","ggplot2")
...
Ici je chiisis une composante connexe particulière
```{r}
...
## Application de diffman sur les différents niveaux de la grislle superposée
